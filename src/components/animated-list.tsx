...
const AnimatedListItemComponent: React.FC<{
  ...
  return (
    <motion.div
      ...
      onMouseDown={onItemClick && clickEffect === "press" ? () => setIsPressed(true) : undefined}
      onMouseUp={onItemClick ? () => setIsPressed(false) : undefined}
      onMouseLeave={onItemClick ? () => setIsPressed(false) : undefined}
      animate={{
...
const AnimatedList: React.FC<AnimatedListProps> = ({
  ...
  const getInitialAnimation = () => {
    if (reduceMotion) return { height: "auto", opacity: 1 };
