      ...
      <div className="flex items-center gap-3.5 min-w-0">
        ...
        <div className="flex flex-col min-w-0">
          <div className="flex items-center gap-1.5">
            ...
            <span className="inline-flex items-center gap-0.5 text-[9px] text-[#187B56] font-bold bg-[#187B56]/10 px-1.5 py-0.2 rounded-md">
          ...
          <span className="font-body-md text-xs text-[#4E5C56]">
